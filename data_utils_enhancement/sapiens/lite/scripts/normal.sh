...
# cd ../../.. || exit
SAPIENS_CHECKPOINT_ROOT=./data_utils_enhancement/sapiens/checkpoint/
...
OUTPUT=$1/sapiens/normal

#--------------------------MODEL CARD---------------
MODEL_NAME='sapiens_0.3b'; CHECKPOINT=$SAPIENS_CHECKPOINT_ROOT/sapiens-normal-0.3b-torchscript/sapiens_0.3b_normal_render_people_epoch_66_torchscript.pt2
...
# MODEL_NAME='sapiens_2b'; CHECKPOINT=$SAPIENS_CHECKPOINT_ROOT/normal/sapiens-normal-2b-torchscript/sapiens_2b_normal_render_people_epoch_70_torchscript.pt2

OUTPUT=$OUTPUT/$MODEL_NAME

##-------------------------------------inference-------------------------------------
RUN_FILE='./data_utils_enhancement/sapiens/lite/demo/vis_normal.py'
