...
def main():
    ...
    parser.add_argument('--config', default="./data_utils_enhancement/easyportrait/local_configs/easyportrait_experiments_v2/fpn-fp/fpn-fp.py", help='Config file')
    parser.add_argument('--checkpoint', default="./data_utils_enhancement/easyportrait/fpn-fp-512.pth", help='Checkpoint file')
