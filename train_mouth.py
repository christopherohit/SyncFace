...
def training(dataset, opt, pipe, testing_iterations, saving_iterations, checkpoint_iterations, checkpoint, debug_from, mode_long, pretrain_ckpt_path):
    testing_iterations = [i for i in range(0, opt.iterations + 1, 10000)]
    ...
    for iteration in range(first_iter, opt.iterations + 1):        
        ...
        au_global_ub = viewpoint_cam.talking_dict['au25'][3]
        ...
        with torch.no_grad():
            ...
            if iteration < opt.densify_until_iter:
                ...
                if iteration > opt.densify_from_iter and iteration % opt.densification_interval == 0:
                    ...
                    if iteration > 2000:
                        bg_color_mask = (colors_precomp[..., 0] < 100/255) * (colors_precomp[..., 1] > 180/255) * (colors_precomp[..., 2] < 100/255)
